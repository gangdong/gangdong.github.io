...
about: true
author: david.dong
description: Some knowledge for Fingerprint driver development.
...
![framework]({{site.baseurl}}/assets/image/others-wbdi-01.PNG){: .center-image }
...
![framework]({{site.baseurl}}/assets/image/others-wbdi-02.PNG){: .center-image }
...
![framework]({{site.baseurl}}/assets/image/others-wbdi-03.PNG){: .center-image }  
