...
![touch-noise-system]({{site.cdn_baseurl}}/assets/image/touch-noise-system.png){: .center-image }
...
![touch-noise-en-spec]({{site.cdn_baseurl}}/assets/image/touch-noise-en-spec.png)
...
![touch-noise-model]({{site.cdn_baseurl}}/assets/image/touch-noise-model.png)
...
4. 确保示波器的GND和大地相连。
![touch-noise-measurement]({{site.cdn_baseurl}}/assets/image/touch-noise-measurement.png)
...
厂家1 对于ITO阻抗的要求
![touch-noise-ito]({{site.cdn_baseurl}}/assets/image/touch-noise-ito-res.png)
...
![touch-noise-pattern]({{site.cdn_baseurl}}/assets/image/touch-noise-ito-pattern.png)
...
![touch-noise-snr]({{site.cdn_baseurl}}/assets/image/touch-noise-snr.png)
