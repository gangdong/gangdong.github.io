...
Published: true
---
I recently completed some image processing work with Pillow Library. Pillow provides a powerful function and has friendly API to the developer. I thought it is necessary to make some notes here for the usage. 
...
**BLUR、CONTOUR、DETAIL、EDGE_ENHANCE、EDGE_ENHANCE_MORE、EMBOSS、FIND_EDGES、SMOOTH、SMOOTH_MORE、SHARPEN**.<br>
